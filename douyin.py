...
class Douyin:
    ...
    def get_hot_search(self):
        ...
        with request_session() as s:
            params = {'version_name': '13.2.0', 'device_platform': 'android'}
            text = s.get(HOT_SEARCH_URL, params=params).text
            obj = json.loads(text)
    ...
    def get_hot_star(self):
        ...
        with request_session() as s:
            params = {'version_name': '13.2.0', 'device_platform': 'android'}
            text = s.get(HOT_STAR_URL, params=params).text
            obj = json.loads(text)
            user_list = obj['data']['user_list']
    ...
    def get_hot_live(self):
        ...
        with request_session() as s:
            params = {'device_platform': 'android',
                      ...
                      'version_code': '130200',
                      'aid': '1128'}
            text = s.get(HOT_LIVE_URL, params=params).text
            obj = json.loads(text)
    ...
    def get_brand_category(self):
        ...
        with request_session() as s:
            params = {'device_platform': 'android',
                      ...
                      'version_code': '130200',
                      'aid': '1128'}
            text = s.get(BRAND_CATEGORY_URL, params=params).text
            obj = json.loads(text)
    ...
    def get_hot_brand(self, category: int):
        ...
        with request_session() as s:
            params = {'category_id': str(category),
                      ...
                      'version_code': '130200',
                      'aid': '1128'}
            text = s.get(HOT_BRAND_URL, params=params).text
            obj = json.loads(text)
    ...
    def get_hot_music(self):
        ...
        text = None
        with request_session() as s:
            params = {'version_name': '13.2.0',
                      'version_code': '130200',
                      'aid': '1128',
                      'chart_id':'6853972723954146568',
                      'count': '100'}
            text = s.get(HOT_MUSIC_URL, params=params).text
            obj = json.loads(text)
